...
add_shortcode( "adventure_gallery", "ck_adventure_gallery_fun" );
function ck_adventure_gallery_fun() {
	ob_start();
	if ( have_rows( 'adventures', 'options' ) ) { ?>
		<section class="adventure_gallery">
			<?php
			while( have_rows( 'adventures', 'options' ) ) {
				...
				<div class="item">
					...
					<div class="content">
						...
						<h3 class="title"><?php echo $linkOpen . get_sub_field( "title" ) . $linkClose; ?></h3>
